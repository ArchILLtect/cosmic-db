...
<?php
    // Page Titles
    // Purpose:         Defines the page titles for the Cosmic Database
    //                  web application.
    // Description:     Defines the page titles for the Cosmic Database
    //                  web application. The page titles are used to
    //                  set the title of each page in the web application.
    //                  The page titles are defined as constants and
    //                  are used in the header of each page.
